...
BS = 32
TS = (24, 24)
train_batch = generator(r"C:\Users\Saanvi\OneDrive\Desktop\train", shuffle=True, batch_size=BS, target_size=TS)
valid_batch = generator(r"C:\Users\Saanvi\OneDrive\Desktop\test", shuffle=True, batch_size=BS, target_size=TS)
